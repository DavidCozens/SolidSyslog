...
| [5.1](https://www.rfc-editor.org/rfc/rfc5425.html#section-5.1) | Authorised peers MUST be specifiable by certificate fingerprint | Partial | [The contract](tls.md) requires a peer to be authorisable by pinned certificate fingerprint in the §4.2.2 form, with a list any one of which authorises. Not every shipped TLS platform delivers it yet - see each platform's page, and [#753](https://github.com/cososo-ltd/solid-syslog/issues/753) |
